...
class REQUEST {
  ...
  async parseRequest() {
    ...
    if (this.app._event.version === '2.0') {
      // Set the method
      this.method = this.app._event.requestContext.http.method
        ? this.app._event.requestContext.http.method.toUpperCase() : 'GET'
      // Set the path
      this.path = this.app._event.rawPath
    } else {
      // Set the method
